...
const Dsp100 = () => {
  ...
  return (
    <div>
        <Header/>
        <Hero title='Building The Next Generation Of Female Techies' text='Join millions of other ladies around the world breaking biases with their Tech Skills' btn='Join next cohort' link='/apply' type="dsp100"/>
